...
This paper is of interest not only for research institutes of the metal-industry, but also for any areas of work, in which the enhancement with augmented reality is possible and a precice tracking is necessary.
}
...
In a 2015 \textit{Olympus} patented the procedure of enhancing the manual inspection with AR-glasses, which help to trace a predefined inspection-plan path.
