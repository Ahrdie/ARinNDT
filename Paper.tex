...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/US-workspace}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/CScan}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/Setup}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/PrecisionMeasurement}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/distancesBoxplot-E}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/distancesBoxplot-W}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=79mm]{images/CScanARUS}
